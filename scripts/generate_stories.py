...
SEASONS = {
    ...
    "s3": {
        ...
        "parts": [
            (1,  "Tokyo"),
            (2,  "Yokohama: First Meeting"),
            (3,  "Tokyo: Second Meeting"),
            (4,  "Yokohama: Pattern Classified"),
            (5,  "Hokkaido"),
            (6,  "Yokohama: Full Records"),
            (7,  "Mediterranean"),
            (8,  "Yokohama: The Protocol"),
            (9,  "The Far South"),
            (10, "Yokohama: The Project"),
            (11, "Yokohama: Departure"),
        ],
        "narrative": (
...
_ROOT_CSS = """\
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero p { font-size: 1rem; color: rgba(255,255,255,0.8); max-width: 440px; margin: 0 auto; line-height: 1.7; }
    .seasons { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; max-width: 960px; margin: -2rem auto 0; padding: 0 1.5rem 4rem; }
    ...
    @media (max-width: 700px) { .seasons { grid-template-columns: 1fr; } .hero h1 { font-size: 1.8rem; } }"""
